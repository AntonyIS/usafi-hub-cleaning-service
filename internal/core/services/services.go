...
func (svc ServiceServiceManagement) GetService(service_id string) (*domain.Service, error) {
...
func (svc RequestServiceManagement) GetRequestByClient(client_id string) error {
	return svc.repo.GetRequestByClient(client_id)
}

func (svc RequestServiceManagement) GetRequestByCleaner(cleaner_id string) error {
...
func (svc ReviewServiceManagement) GetReviewByClient(client_id string) error {
	return svc.repo.GetReviewByClient(client_id)
}
func (svc ReviewServiceManagement) GetReviewByCleaner(cleaner_id string) error {
